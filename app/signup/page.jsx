                    ...
                    <div dir='rtl' className="col-span-3 lg:col-span-2 flex flex-col items-start justify-center gap-4 bg-white  p-10 rounded-2xl">
                        ...
                        <form className='flex flex-col gap-3 w-full' dir='rtl'>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="relative w-full">
                                        ...
                                        <input type="text" id="fname" placeholder='الاسم الأول' className='w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500' />
                                    </div>
                                </div>
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="relative w-full">
                                        <FaRegUser className='absolute left-2 top-[calc(9px)] text-2xl text-gray-500' />
                                        <input type="text" id="lname" placeholder='الاسم الأخير' className='w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500' />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="relative w-full">
                                ...
                                <input  type="password" id="password" placeholder='كلمة المرور' className='w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500' />
                            </div>
